...
class WordProperties:
    ...
    def __init__(self, word, sentence, word_idx_in_sentence):
        self.word = word
        ...
        self.roberta_embedding_first_layer = -1
        self.roberta_embedding_middle_layer = -1
        self.roberta_embedding_last_layer = -1
        self.roberta_embedding_mean = -1
        self.surprisal = -1
